...
<head>
    ...
    <title>{{ $title }} - SMARTHOME 2026</title>

    <!-- General CSS Files -->
    <link rel="stylesheet" href="{{ asset('/assets/stisla/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="https://assets.midragondev.my.id/css/all.min.css">
    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="{{ url('dashboard') }}" class="navbar-brand sidebar-gone-hide">SMARTHOME</a>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2026 <div class="bullet"></div> Created By <a
